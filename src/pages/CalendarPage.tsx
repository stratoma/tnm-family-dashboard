...
export default function CalendarPage() {
  ...
  const calendars = Array.from(new Set(calendarSeed.map((event) => event.calendar)));
  ...
  return (
    <>
      <PageHeader
        ...
        description="Connect multiple Google Calendars, choose which ones to show, and keep events read-only until editing is added later."
        action={
